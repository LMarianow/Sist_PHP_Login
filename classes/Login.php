...
class Login
{
    ...
    public function sendPasswordResetMail($user_name, $user_email, $user_password_reset_hash)
    {
        ...
        $mail->Body = EMAIL_PASSWORDRESET_CONTENT .$user_name.'
Foi feito um pedido de mudança de senha na sua conta SuaEmpresa.
Para redefinir a senha, entre neste link: '.$link.'
Caso não tenha pedido a mudança de senha ignore esse email.';
