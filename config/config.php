 ...
 */
define("DB_HOST", "seuhost.x");
define("DB_NAME", "NomeDaDatabase");
define("DB_USER", "Usuario da Database");
define("DB_PASS", "Senha da Database");
...
define("COOKIE_DOMAIN", ".seuhost.x");
 ...
 */
define("EMAIL_USE_SMTP", true);
define("EMAIL_SMTP_HOST", "ssl://mail.seuhost.x");
define("EMAIL_SMTP_AUTH", true);
define("EMAIL_SMTP_USERNAME", "no-reply@seuhost.x");
define("EMAIL_SMTP_PASSWORD", "lucas2798");
define("EMAIL_SMTP_PORT", 465);
define("EMAIL_SMTP_ENCRYPTION", "ssl");
 ...
 */
define("EMAIL_PASSWORDRESET_URL", "https://seuhost.x/LMCadastro/password_reset.php");
define("EMAIL_PASSWORDRESET_FROM", "no-reply@seuhost.x");
define("EMAIL_PASSWORDRESET_FROM_NAME", "SuaEmpresa");
define("EMAIL_PASSWORDRESET_SUBJECT", "Esqueci minha senha SuaEmpresa");
define("EMAIL_PASSWORDRESET_CONTENT", "Prezado, ");

/**
 * Configuration for: verification email data
 * Set the absolute URL to register.php, necessary for email verification links
 */
define("EMAIL_VERIFICATION_URL", "https://seuhost.x/LMCadastro/register.php");
define("EMAIL_VERIFICATION_FROM", "no-reply@seuhost.x");
define("EMAIL_VERIFICATION_FROM_NAME", "SuaEmpresa");
define("EMAIL_VERIFICATION_SUBJECT", "Ativaчуo de conta SuaEmpresa");
define("EMAIL_VERIFICATION_CONTENT", "Bem-vindo(a) a SuaEmpresa, ");
