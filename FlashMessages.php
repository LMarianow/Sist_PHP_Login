...
class FlashMessages {
    ...
    {
        return $this->add('<strong>Parabens ! </strong>'.$message, self::SUCCESS, $redirectUrl, $sticky);
    }
    ...
    {
        return $this->add('<strong>Atencao : </strong>'.$message, self::WARNING, $redirectUrl, $sticky);
    }
    ...
    {
        return $this->add('<strong>Atencao : </strong>'.$message, self::ERROR, $redirectUrl, $sticky);
    }
